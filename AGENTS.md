...
- After completing a user-requested implementation change and passing verification, create a git commit and push it to the configured remote unless the user explicitly asks not to.
