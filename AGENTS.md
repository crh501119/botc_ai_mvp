...
- After completing a user-requested implementation change and passing verification, create a git commit for the update unless the user explicitly asks not to.
